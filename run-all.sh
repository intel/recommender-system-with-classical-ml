...
./prep-env.sh -a hadoop-master -b hadoop-master -c 0 -d 0
echo -e "\n"
sleep 10
...
python /mnt/code/src/models/xgboost/train_stage1.py 
echo -e "\n"

echo -e "\ncreate data for stage 2...."
python /mnt/code/src/models/xgboost/train_merge12.py
echo -e "\n"

echo -e "\nstart training stage 2...."
python /mnt/code/src/models/xgboost/train_stage2.py
echo -e "\n"
