...
cp /mnt/config/hadoop-env.sh $HADOOP_HOME/etc/hadoop/hadoop-env.sh && \
cp /mnt/config/hdfs-site.xml $HADOOP_HOME/etc/hadoop/hdfs-site.xml && \
cp /mnt/config/core-site.xml $HADOOP_HOME/etc/hadoop/core-site.xml && \
cp /mnt/config/mapred-site.xml $HADOOP_HOME/etc/hadoop/mapred-site.xml && \
cp /mnt/config/yarn-site.xml $HADOOP_HOME/etc/hadoop/yarn-site.xml && \
cp /mnt/config/slaves $HADOOP_HOME/etc/hadoop/slaves && \
cp /mnt/config/ssh_config /root/.ssh/config && \
cp /mnt/config/spark-env.sh $SPARK_HOME/conf/spark-env.sh && \
cp /mnt/config/spark-defaults.conf $SPARK_HOME/conf/spark-defaults.conf 
...
/opt/spark-3.3.0-bin-hadoop3/bin/spark-submit --class org.apache.spark.examples.SparkPi --master spark://$MAIN:7077 /opt/spark-3.3.0-bin-hadoop3/examples/jars/spark-examples_2.12-3.3.0.jar 10
